                ...
                <div class="bg-white shadow rounded-lg">
                    <div class="px-4 py-5 sm:p-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="flex items-center justify-between p-3 bg-white rounded border">
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Order #ORD-004</p>
                                    <p class="text-sm text-gray-500">Customer: Alice Brown - $98.75</p>
                                </div>
                    ...
                    <div class="space-y-3">
                        <div class="flex items-center justify-between p-3 bg-yellow-50 rounded">
                            <div class="flex items-center">
                                ...
                                <div>
                                    ...
                                    <p class="text-sm text-gray-500">Only 3 items left in stock</p>
                                </div>
                            </div>
                        ...
                        <div class="flex items-center justify-between p-3 bg-red-50 rounded">
                            <div class="flex items-center">
                                ...
                                <div>
                                    <p class="text-sm font-medium text-gray-900">Smart Watch Series 5</p>
